...
export function Button({ text, address }) {
    return (
        ...
        <button className='flex bg-blue-1 font-main font-bold text-subtitle justify-center items-center mb-4 text-center ring-2 ring-blue-3 rounded-full text-blue-3 w-full h-16'>
