...
export function CoursesDropDown() {
  //funtion to up and down the div if the checkbox is checked or not
  function dropDown(input) {
    ...
    if (input.checked) {
      ...
      coursesBox.style.borderRadius= "0.8rem"
      
    } else {
      coursesBox.style.height = "2rem";
      coursesBox.style.transition = "height 0.5s";
      coursesBox.style.borderRadius= "1.5rem"
    }
  }
    ...
    <div id="coursesBox" className="h-[2rem] overflow-hidden lg-[1440px]:flex flex-col py-1 px-2 bg-blue-1 rounded-3xl ring-[1px] ring-[#11567D] shadow-md">
      <div className="flex justify-between">
        ...
        <div className='relative'>
          <input onChange={(e) => dropDown(e.target)} className="absolute opacity-0 size-5" id="applyFilters" name="" type="checkbox" />
          <img alt="" className="size-5" src={Course} />
        </div>
      </div>
