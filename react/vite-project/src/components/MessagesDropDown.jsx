...
export function MessagesDropDrown() {
  ...
  <div className="fixed inset-0 z sm:absolute scale-y-0 group-focus:scale-y-100 origin-top duration-200 sm:w-[25rem] min-h-[33rem] ring-2 ring-blue-3 rounded-sm bg-blue-1 sm:inset-auto sm:right-0 z-40 sm:top-14">
    ...
    <p className="pl-2 pt-2 text-texto font-second font-bold text-blue-3 border-t-2 border flex justify-between">
      Mensajes <button className="pr-2">salir</button>
    </p>
