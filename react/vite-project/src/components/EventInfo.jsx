 ...
 */
export function EventInfo({ closeModal, addEvent, action, titulo, texto, image, hora, cat, fecha, tag, curso }) {
                ...
                <div className="p-4 max-h-full">
                    <div className=' bg-white ring-1 ring-blue-3 rounded-2xl lg:w-[40vw] w-[80vw] px-8 text-center py-5'>
                        <div className='flex items-center gap-x-5'>
                            <h1 className="w-full mb-4 h-16 text-center text-blue-3 focus:outline-none text-subtitulo font-regular font-second">{titulo}</h1>
                            <UpLoad/>
                        </div>
