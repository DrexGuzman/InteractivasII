    ...
    <div className="mb-8">
      ...
      <div className="relative bg-blue-2 grid sm:grid-cols-3 grid-cols-2 py-2 sm:px-8 px-4 sm:gap-x-10 gap-x-28">
        ...
        <div className="items-center justify-center hidden sm:flex">
          <form action="" className="flex justify-between h-[2rem] bg-blue-1 rounded-full w-[-webkit-fill-available]">
            <input
        ...
        <div className="flex flex-col gap-y-4">
          ...
          <div className="flex flex-col gap-y-4">
            ...
            <div className="px-4 justify-between items-center bg-blue-1 flex sm:h-[3.5rem] h-[2rem] rounded-full sm:hidden">
              <h1 className="texto text-blue-3 text-center">Aplicar filtros</h1>
              <input className="hidden absolute size-8" id="" name="" type="checkbox" />
              <img alt="" className="size-6" src={ImgFilter} />
            </div>
            <hr className="sm:hidden w-[90vw] text-white bg-white" />

            <div className="px-4 justify-between items-center bg-blue-1 flex sm:h-[3.5rem] h-[2rem] rounded-full sm:hidden">
              <h1 className="texto text-blue-3 text-center">Cursos matriculados</h1>
              <input className="hidden absolute size-8" id="" name="" type="checkbox" />
              <img alt="" className="size-6" src={ImgCourse} />
            </div>
            ...
            <hr className="w-[90vw] text-white bg-white" />
            <Link to='/' className="texto text-white flex justify-center">Cerrar sesión</Link>
          </div>
        </div>
      </div>
    </div>
