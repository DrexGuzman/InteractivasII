        ...
        <div className='flex flex-col justify-center relative'>
            ...
            <div className="rounded-2xl min-h-32 ring-1 bg-white ring-[#11567D] relative flex flex-row justify-center items-center   py-4 px-8 gap-4">
                ...
                <div className='flex flex-col items-center sm:items-start  min-w-[135px]  '>
                        <h1 className='font-main   text-subtitulo font-pesado text-blue-3'>Lorem ipsum dolor sitet.</h1>
                    <div className='hidden sm:flex'>
                    <p className='  text-blue-3 text-texto font-second sm:line-clamp-2'> Lorem ipsum dolor sit amet consectetur. Feugiat hendrerit aliquet diam vulputate nibh. Adipisci dapibus. Elit commodo ullamcorper eu ac sit sit... </p>
                    </div>
