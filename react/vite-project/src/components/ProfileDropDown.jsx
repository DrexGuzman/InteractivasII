...
export const ProfileDropDown = () => {
  ...
  return (
    <div id="profileBox" className={`overflow-y-hidden  h-[10rem] flex flex-col rounded-2xl relative py-8 mt-2 transition-all duration-500 ${isOpen ? 'h-[25rem] ring-1 ring-white' : 'h-[6rem]'}`}>
